...
content = file.text;
assert assertContains(file, content, 'License from classpath header.');

file = new File(basedir, 'child2/LICENSE.txt');
assertExistsFile(file);

content = file.text;
assert assertContains(file, content, 'Full License from classpath.');
