...
import org.opennms.maven.plugins.license.api.ArtifactFilters.Builder;
...
public class ArtifactFiltersTest
{
        ...
        throws IOException, InvalidVersionSpecificationException
    {
        ...
        final URL url = getClass().getClassLoader().getResource( "org/opennms/maven/plugins/license/api/atifact-filters.txt" );
