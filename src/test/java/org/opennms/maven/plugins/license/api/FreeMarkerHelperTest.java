...
public class FreeMarkerHelperTest
{
        ...
        throws Exception
    {
        ...
        String s = helper.renderTemplate( "/org/opennms/maven/plugins/license/third-party-file.ftl", properties );
        LOG.info( "{}", s );
    }
        ...
        throws Exception
    {
        ...
        String s =
            helper.renderTemplate( "/org/opennms/maven/plugins/license/third-party-file-groupByLicense.ftl", properties );
        LOG.info( "{}", s );
    }
        ...
        throws Exception
    {
        ...
        String s =
            helper.renderTemplate( "/org/opennms/maven/plugins/license/default-file-header-description.ftl", properties );
