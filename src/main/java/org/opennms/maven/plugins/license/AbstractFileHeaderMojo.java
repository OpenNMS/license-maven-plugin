...
import org.opennms.maven.plugins.license.api.FreeMarkerHelper;
import org.opennms.maven.plugins.license.header.FileHeader;
import org.opennms.maven.plugins.license.header.FileHeaderProcessor;
import org.opennms.maven.plugins.license.header.InvalideFileHeaderException;
import org.opennms.maven.plugins.license.header.UpdateFileHeaderFilter;
import org.opennms.maven.plugins.license.header.transformer.FileHeaderTransformer;
import org.opennms.maven.plugins.license.header.transformer.JavaFileHeaderTransformer;
import org.opennms.maven.plugins.license.model.Copyright;
import org.opennms.maven.plugins.license.model.License;
...
public abstract class AbstractFileHeaderMojo extends AbstractLicenseNameMojo
{
    ...
    @Parameter( property = "license.descriptionTemplate",
            defaultValue = "/org/opennms/maven/plugins/license/default-file-header-description.ftl" )
